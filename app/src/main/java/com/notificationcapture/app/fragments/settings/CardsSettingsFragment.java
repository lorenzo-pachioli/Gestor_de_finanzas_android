...
// ARCHIVO NUEVO: app/src/main/java/com/notificationcapture/app/fragments/settings/CardsSettingsFragment.java
...
public class CardsSettingsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_settings_cards, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button btnAdd = view.findViewById(R.id.btnAddCreditCard);
        btnAdd.setOnClickListener(v -> showAddCreditCardDialog());
        ...
        spinnerCreditCards.setOnItemSelectedListener(new android.widget.AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(android.widget.AdapterView<?> parent, View v, int position, long id) {
                if (position > 0) {
                    showEditCreditCardDialog(currentCreditCards.get(position - 1));
    ...
    private void loadCreditCards() {
        ...
        displayList.add(new CreditCard("Seleccionar para editar/borrar...", 0, 0));
    ...
    private void showAddCreditCardDialog() {
        ...
        btnCreate.setOnClickListener(v -> {
            ...
            int closingDate = 1;
            try {
                closingDate = Integer.parseInt(etClosingDate.getText().toString().trim());
                if (closingDate < 1 || closingDate > 31) closingDate = 1;
            } catch (NumberFormatException ignored) {}
            if (!name.isEmpty()) {
                creditCardRepository.addCreditCard(new CreditCard(name, closingDate, selectedColor));
                loadCreditCards();
    ...
    private void showEditCreditCardDialog(CreditCard card) {
        ...
        populateColorPicker(containerColors, CatColors.getIntEgresosColors());
    ...
    private void populateColorPicker(LinearLayout container, int[] colors) {
        ...
        int strokePx = Math.round(3 * density);
        ...
        for (int color : colors) {
            ...
            if (color == selectedColor) drawable.setStroke(strokePx, Color.BLACK);
            ...
            colorDot.setOnClickListener(v -> {
                ...
                drawable.setStroke(strokePx, Color.BLACK);
            });
